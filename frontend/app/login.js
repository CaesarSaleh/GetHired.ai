...
const Login = () => {
    ...
    useEffect(() => {
        document.title = 'GetHired.ai Login';
    }, []);
  ...
  const handleLogin = (e) => {
    ...
    if ((data.email=== 'caesar@gmail.com') && data.password === '12345') {
      router.push('/landing')
    }
  }
    ...
    <div className='h-screen  justify-center'>
        <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-757575 text-[#757575]">Sign in to your account</h2>
            </div>
            ...
            } value={data.email} name="email" type="email" required className="focus:outline-none block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#757575] sm:text-sm sm:leading-6 pl-2"/>
                    </div>
                </div>

                <div>
                    <div className="flex items-center justify-between">
                    <label className="block text-sm font-medium leading-6 text-757575 text-[#757575]">Password</label>
